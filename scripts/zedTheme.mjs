...
function buildZedTheme(vscodeTheme, appearance) {
  ...
  return clean({
    ...
    style: {
      ...
      'border.focused': semantic.namespace.foreground,
      'border.selected': semantic.namespace.foreground,
      'border.transparent': `${colors['tab.border']}00`,
      'border.variant': colors['sideBar.border'],
      conflict: colors['editorWarning.foreground'],
      'conflict.background': colors['merge.currentContentBackground'],
      'conflict.border': colors['merge.border'],
      ...
      'deleted.background': colors['merge.currentContentBackground'],
      ...
      'editor.highlighted_line.background': colors['editor.lineHighlightBackground'],
      ...
      'hint.background': colors['inputValidation.infoBackground'],
      'hint.border': colors['editorHint.foreground'],
      icon: colors['activityBar.foreground'],
      'icon.accent': semantic.namespace.foreground,
      ...
      'link_text.hover': semantic.type.foreground,
      ...
      predictive: semantic.function.foreground,
      'predictive.background': colors['editor.wordHighlightBackground'],
      'predictive.border': semantic.function.foreground,
      ...
      'text.accent': semantic.namespace.foreground,
